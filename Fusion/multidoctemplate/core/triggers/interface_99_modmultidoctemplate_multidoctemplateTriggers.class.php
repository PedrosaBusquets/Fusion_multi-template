...
class InterfacemultidoctemplateTriggers extends DolibarrTriggers
{
    /**
    ...
    public function __construct($db)
    {
        ...
        $this->family = "demo";
        $this->description = "multidoctemplate triggers.";
    ...
    {
        if (empty($conf->multidoctemplate->enabled)) return 0;     // Module not active, we do nothing
