...
/**
 * \file    test/functional/DoctemplateFunctionalTest.php
 * \ingroup doctemplate
...
/**
 * Class DoctemplateFunctionalTest
 *
 ...
 *
 * @package Testdoctemplate
 */
class DoctemplateFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modDoctemplate')->click();
		} else {
			// Disable the module
			$this->byHref('modDoctemplate')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/doctemplate/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('doctemplate/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/doctemplate/admin/about.php');
		$this->authenticate();
		return $this->assertContains('doctemplate/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('doctemplatewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDoctemplate_DoctemplateTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDoctemplate_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
