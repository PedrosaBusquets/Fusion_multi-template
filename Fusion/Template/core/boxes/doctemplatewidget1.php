...
/**
 * \file    modulebuilder/template/core/boxes/doctemplatewidget1.php
 * \ingroup doctemplate
 * \brief   Widget provided by Doctemplate
 *
 ...
 */
class doctemplatewidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "doctemplatebox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "doctemplate@doctemplate";
	 ...
	 */
	public $depends = array('doctemplate');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->doctemplate->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/doctemplate/class/doctemplate.class.php";

		// Populate the head at runtime
		$text = $langs->trans("DoctemplateBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_doctemplate@doctemplate',
