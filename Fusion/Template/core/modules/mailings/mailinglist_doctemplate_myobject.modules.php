...
dol_include_once("/doctemplate/class/myobject.class.php");


/**
 * mailing_mailinglist_doctemplate
 */
class mailing_mailinglist_doctemplate_myobject extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	var $name='mailinglist_doctemplate_myobject';
	...
	var $picto='doctemplate@doctemplate';
	...
	function __construct($db)
	{
		...
		{
			$this->enabled=in_array('doctemplate',$conf->modules)?1:0;
		}
	}
	...
	function url($id)
	{
		return '<a href="'.dol_buildpath('/doctemplate/myobject_card.php',1).'?id='.$id.'">'.img_object('',"generic").'</a>';
	}
	...
	function add_to_target($mailing_id,$filtersarray=array())
	{
		...
		if ($result)
		{
			...
			dol_syslog("mailinglist_doctemplate_myobject.modules.php: mailing ".$num." targets found");
