...
require_once DOL_DOCUMENT_ROOT.'/custom/doctemplate/core/lib/company.lib.php';
...
require_once DOL_DOCUMENT_ROOT.'/custom/doctemplate/class/societe.class.php';
...
else
{
    ...
    if ($action == 'create')
    {
        ...
        dol_fiche_head(null, 'documentfiles', '', 0, '');
    ...
    elseif ($action == 'edit')
    {
        ...
        if ($socid)
        {
	        ...
	        $head = cust_societe_prepare_head($object);
            ...
            dol_fiche_head($head, 'documentfiles', $langs->trans("ThirdParty"), 0, 'company');
    ...
    else
    {
        ...
        dol_fiche_head($head, 'documentfiles', $langs->trans("ThirdParty"), -1, 'company');
