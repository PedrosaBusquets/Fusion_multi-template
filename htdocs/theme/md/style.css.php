...
/* -------------------------------------------------
 * PESTAÑA NO SELECCIONADA (estado normal)
 * Icono + texto gris apagado, tamaño normal
 * ------------------------------------------------- */
...
li.tmenu .tmenulabel .mainmenuaspan {
	color: #b8b3cf;
	opacity: 0.8;
}
 ...
 * Icono blanco y más grande, texto blanco
 * ------------------------------------------------- */
...
li.tmenusel div.mainmenu.topmenuimage > span.far {
	color: var(--colortextbackhmenu);
	opacity: 1;
	transform: scale(1.25);   /* un poco menor que 1.35 para reducir “tintineo” */
}

li.tmenusel .tmenulabel .mainmenuaspan {
	color: var(--colortextbackhmenu);
	opacity: 1;
}

/* -------------------------------------------------
 * HOVER SOBRE NO SELECCIONADA
 * Icono + texto se comportan como seleccionada
 * ------------------------------------------------- */

/* Icono en hover: blanco y mismo tamaño que el seleccionado */
...
/* TEXTO en hover: blanco también */
li.tmenu:hover .tmenulabel .mainmenuaspan {
	color: var(--colortextbackhmenu);
	opacity: 1;
}

/* -------------------------------------------------
 * HOVER SOBRE YA SELECCIONADA (opcional, muy suave)
 * ------------------------------------------------- */

li.tmenusel:hover div.mainmenu.topmenuimage > span.fas,
li.tmenusel:hover div.mainmenu.topmenuimage > span.far {
	transform: scale(1.3);   /* casi igual que 1.25 para evitar salto brusco */
}

li.tmenusel:hover .tmenulabel .mainmenuaspan {
	color: var(--colortextbackhmenu);
	opacity: 1;
}
